(ns graphql-facade.components
  (:require [com.stuartsierra.component :as component]
            [graphql-facade.routes :refer [routes]]
            [graphql-facade.diplomat.sqs :as sqs]
            [graphql-facade.db.datomic.config :as datomic.config]
...
(defn base-system [config-name]
  (component/system-map
    ...
    :http (component/using (components.http-client/new-http-client) [:config :token])
